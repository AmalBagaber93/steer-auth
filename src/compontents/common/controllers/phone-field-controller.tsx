                        ...
                        return (
                            <FormItem className="shrink-0">
                                ...
                                >
                                    <DropdownMenuTrigger
                                        className={cn(
                                            'flex h-10 w-26.25 items-center justify-between gap-1 rounded-md border border-input bg-background px-3 text-sm text-gray-800 shadow-sm',
                                            'rounded-r-none',
                                            'focus:outline-none focus:ring-2 focus:ring-ring',
                                            error && 'border-destructive',
                                        )}
                                    >
                                        <span className="font-medium tabular-nums">+{selected?.dial_code ?? '966'}</span>
